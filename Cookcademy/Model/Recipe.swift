...
//  Cookcademy
//
//  Created by Laura Belen Yachelini on 25/07/2023.
//
...
struct Ingredient: RecipeComponent{
  ...
  //The description property will return a String that describes the Ingredient in a more readable format.
  var description: String {
  ...
  enum Unit: String, CaseIterable, Codable {
     ...
     case tsp = "Teaspoons"
     case none = "No units"
    //singularName takes the rawValue (e.g. “Teaspoons”) and drops the last character. Now you can print both the singular and plural versions of an ingredient.
...
extension Recipe: RecipeComponent {
  var description: String {
    ""  
  }
